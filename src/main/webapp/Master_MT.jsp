...
ul#navmenu, ul.sub1, ul.sub2 {
		...
		margin-top:1px;
		width:120px;
                margin-left:15px;/*Adjusts distance between sub-list within primary list*/		
		padding:0px;
		}			
 ...
 <%
       ...
       //String V_NmS = (String)session.getAttribute("theName");
      // session.setAttribute( "theName", V_Nm );
          ...
          if(rs.next())
              {
                  ...
                  // out.println("Welcome " + V_Nm + " To Retail Solutions Pvt Lmt" + df.format(date) ); 
 ...
 <!-- -<li><a  href="Home_Page.jsp?Value77=<%= (String)session.getAttribute("theName")%>">Home</a></li> --> 
...
<ul id="navmenu">
 ...
 <li align="center"><a href="Maint_Report.jsp" target="ck">Maint_Report</a></li>
                 </ul>
                 </li>
		 <li>
		...
		<li><a href="TicketGenerate.jsp" target="ck">Generate Ticket</a></li> 
		 <li><a href="ShowTcktStatus.jsp" target="ck">showtckStatus</a></li>
            ...
            <tr bgcolor="#FDF3E7" >
             <td style="z-index:-10">
    <iframe  src=""  width="820" height="350" frameborder="0" name="ck" id="ck" style="margin-top:3%">
    </iframe>
</td>
...
<table  style="margin:6 px" border="0">
  <tr bgcolor="#FE6601">
    <td> <div id="footer" align="center" >Copyright &copy; 99 Retail Solutions Private Limited</div></td>
  </tr>
</table>
<%
              }
                  ...
                  <div id='login-panel' class='view-panel  '>
                    <div class="left1">
		                <div class="line1 s1">
						 ...
						 <form   action="Master_MT.jsp"  method="POST">
		                 <div class="s2">
                       ...
                       <div class="line4">
                         <img src="/themes/rex/images/divider.png" style="width:230px" height="2"><a href="#reset-panel" id='reset-password-link' class="login-nav s6" tabindex="5">Forgot Password</a>                      
